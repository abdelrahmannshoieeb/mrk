        ...
        <div class="flex justify-between">
            <a href="{{ route('home') }}">
                <img style="height: 58px" class="max-h-[68px] w-auto inline-block dark:hidden" src="images/mrk-w.png"
                    alt="logo" />
                <img style="height: 58px" class="max-h-[68px] w-auto dark:inline-block hidden" src="images/mrk-d.png"
                    alt="logo" />
            </a>
            ...
            <div class="middle_header" >
                <a style="font-size: 16px; font-weight: bold; margin-top: 14px;" href="{{ route('ecom') }}">{{ __('header.ecomm') }}</a>
                <a style="font-size: 16px; font-weight: bold; margin-top: 14px;" href="{{ route('packages') }}">{{ __('header.packages') }}</a>
                <a style="font-size: 16px; font-weight: bold; margin-top: 14px;" href="{{ route('prog') }}">{{ __('index.Our_Services') }}</a>
                <a style="font-size: 16px; font-weight: bold; margin-top: 14px;" href="{{ route('cgi') }}">CGI</a>
            </div>
                ...
                <span>
                    <a href=" https://www.facebook.com/marketingdoseofficial" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 20 20"
                            fill="none" class="stroke-[#565656] hover:stroke-white duration-200">
                            <path
                ...
                <span>
                    <a href="https://www.instagram.com/marketingdoseofficial?igsh=MTc1ejJhMjZyNWFo">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="stroke-[#565656] hover:stroke-white duration-200" width="23" height="23"
